...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-white pt-24 pb-0">
      ...
      <div
        className="absolute top-[-120px] left-[-100px] w-[600px] h-[600px] rounded-full opacity-[0.06] pointer-events-none animate-blob"
        style={{ background: "radial-gradient(circle, #f97316 0%, transparent 70%)" }}
      />
      <div
        className="absolute top-[100px] right-[-150px] w-[500px] h-[500px] rounded-full opacity-[0.05] pointer-events-none animate-blob"
        style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center pt-16 pb-20">
          {/* Badge */}
          <div className="hero-fade-1 inline-flex items-center gap-2 bg-orange-50 border border-orange-100 rounded-full px-4 py-1.5 mb-8">
          ...
          {/* Headline */}
          <h1 className="hero-fade-2 text-5xl sm:text-6xl lg:text-7xl font-bold text-slate-900 leading-[1.08] tracking-tight mb-6 max-w-4xl mx-auto">
            Le garage moto{" "}
          ...
          {/* Subheadline */}
          <p className="hero-fade-3 text-xl text-slate-500 max-w-2xl mx-auto mb-8 leading-relaxed">
          ...
          {/* Checks */}
          <div className="hero-fade-4 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mb-10">
            {highlights.map((h) => (
              <span
                key={h}
          ...
          {/* CTAs */}
          <div className="hero-fade-4 flex flex-col sm:flex-row gap-3 justify-center mb-14">
            <a
              href="#contact"
              className="inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white font-semibold px-7 py-3.5 rounded-xl text-base transition-all shadow-lg shadow-slate-900/20 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 duration-200"
            >
            ...
            <a
              href="#tarifs"
              className="inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 font-semibold px-7 py-3.5 rounded-xl text-base transition-all hover:-translate-y-0.5 active:translate-y-0 duration-200"
            >
              Voir les tarifs
            </a>
          </div>
          ...
          {/* Social proof */}
          <div className="hero-fade-5 flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-slate-500">
        ...
        <div className="hero-fade-6 relative -mb-1">
          ...
          <div className="animate-float">
            <div className="bg-slate-900 rounded-t-2xl border border-slate-800 border-b-0 shadow-2xl shadow-slate-900/30 overflow-hidden max-w-5xl mx-auto">
              {/* Browser chrome */}
