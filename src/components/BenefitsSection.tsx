      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {metrics.map(({ value, unit, description, color }) => (
            ...
            >
              <div
                className={`text-5xl font-black mb-1 ${colorMap[color]}`}
              >
                {value}
              </div>
        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-4xl font-black text-orange-400 mb-1">150+</div>
            ...
            <div className="md:border-x border-white/10">
              <div className="text-4xl font-black text-orange-400 mb-1">25 000+</div>
            ...
            <div>
              <div className="text-4xl font-black text-orange-400 mb-1">98%</div>
