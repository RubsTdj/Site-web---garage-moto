(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,95116,e=>{"use strict";let t=(0,e.i(75254).default)("wrench",[["path",{d:"M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.106-3.105c.32-.322.863-.22.983.218a6 6 0 0 1-8.259 7.057l-7.91 7.91a1 1 0 0 1-2.999-3l7.91-7.91a6 6 0 0 1 7.057-8.259c.438.12.54.662.219.984z",key:"1ngwbx"}]]);e.s(["Wrench",0,t],95116)},18566,(e,t,s)=>{t.exports=e.r(76562)},92161,e=>{"use strict";let t=(0,e.i(75254).default)("menu",[["path",{d:"M4 5h16",key:"1tepv9"}],["path",{d:"M4 12h16",key:"1lakjw"}],["path",{d:"M4 19h16",key:"1djgab"}]]);e.s(["Menu",0,t],92161)},45678,e=>{"use strict";var t=e.i(43476),s=e.i(71645),a=e.i(22016),n=e.i(18566),i=e.i(92161),r=e.i(37727),o=e.i(95116);let l=[{href:"/#portail-client",label:"Portail client"},{href:"/#dashboard",label:"Dashboard"},{href:"/#fonctionnalites",label:"Comment ça marche"},{href:"/#tarifs",label:"Tarifs"},{href:"/blog",label:"Blog"}];e.s(["default",0,function(){let[e,c]=(0,s.useState)(!1),[u,d]=(0,s.useState)(!1),x=(0,n.usePathname)();return(0,s.useEffect)(()=>{let e=()=>d(window.scrollY>20);return window.addEventListener("scroll",e),()=>window.removeEventListener("scroll",e)},[]),(0,t.jsxs)("header",{className:`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${u?"bg-white/95 backdrop-blur-md shadow-sm border-b border-slate-100":"bg-transparent"}`,children:[(0,t.jsxs)("nav",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between",children:[(0,t.jsxs)(a.default,{href:"/",className:"flex items-center gap-2 flex-shrink-0",children:[(0,t.jsx)("div",{className:"w-8 h-8 bg-slate-900 rounded-lg flex items-center justify-center",children:(0,t.jsx)(o.Wrench,{className:"w-4 h-4 text-orange-400"})}),(0,t.jsxs)("span",{className:"font-bold text-xl text-slate-900",children:["Garage",(0,t.jsx)("span",{className:"text-orange-500",children:"OS"})]})]}),(0,t.jsx)("div",{className:"hidden lg:flex items-center gap-6 xl:gap-8",children:l.map(e=>{let s="/blog"===e.href&&x.startsWith("/blog");return(0,t.jsx)(a.default,{href:e.href,className:`text-sm font-medium transition-colors whitespace-nowrap ${s?"text-orange-500":"text-slate-600 hover:text-slate-900"}`,children:e.label},e.href)})}),(0,t.jsxs)("div",{className:"hidden lg:flex items-center gap-3",children:[(0,t.jsx)(a.default,{href:"/login",className:"text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors whitespace-nowrap",children:"Connexion"}),(0,t.jsx)(a.default,{href:"/#contact",className:"text-sm font-semibold bg-slate-900 hover:bg-slate-800 text-white px-4 py-2 rounded-lg transition-colors whitespace-nowrap",children:"Démo gratuite"})]}),(0,t.jsx)("button",{className:"lg:hidden p-2 text-slate-700 rounded-lg hover:bg-slate-100 transition-colors",onClick:()=>c(!e),"aria-label":"Menu",children:e?(0,t.jsx)(r.X,{className:"w-5 h-5"}):(0,t.jsx)(i.Menu,{className:"w-5 h-5"})})]}),e&&(0,t.jsxs)("div",{className:"lg:hidden bg-white border-t border-slate-100 px-4 py-4 space-y-1 shadow-lg",children:[l.map(e=>(0,t.jsx)(a.default,{href:e.href,onClick:()=>c(!1),className:"block text-sm font-medium text-slate-700 hover:text-orange-500 py-2.5 border-b border-slate-50 last:border-0 transition-colors",children:e.label},e.href)),(0,t.jsx)(a.default,{href:"/login",onClick:()=>c(!1),className:"block text-sm font-medium text-slate-600 py-2.5 border-b border-slate-50 transition-colors",children:"Connexion"}),(0,t.jsx)(a.default,{href:"/#contact",onClick:()=>c(!1),className:"block text-sm font-semibold bg-slate-900 text-white text-center py-3 rounded-xl mt-3 hover:bg-slate-800 transition-colors",children:"Demander une démo gratuite"})]})]})}])},72520,e=>{"use strict";let t=(0,e.i(75254).default)("arrow-right",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);e.s(["ArrowRight",0,t],72520)},3116,e=>{"use strict";let t=(0,e.i(75254).default)("clock",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 6v6l4 2",key:"mmk7yg"}]]);e.s(["Clock",0,t],3116)},82388,e=>{"use strict";var t=e.i(43476),s=e.i(71645),a=e.i(22016),n=e.i(72520),i=e.i(3116);let r=[{slug:"fidelisation-clients-moto",title:"5 façons de fidéliser vos clients moto sans effort",excerpt:"La fidélisation client est le nerf de la guerre pour un garage moto. Voici 5 techniques concrètes, applicables immédiatement, qui transforment un client occasionnel en ambassadeur.",category:"Fidélisation",readTime:"6 min",date:"12 mars 2025",author:{name:"Antoine Rousseau",initials:"AR",role:"CEO, GarageOS"},content:`
...
En cas de doute, la CNIL propose un guide gratuit pour les TPE/PME sur son site.
    `}],o=["Tous","Fidélisation","Automatisation","Intégrations","Réglementation"];e.s(["default",0,function(){let[e,l]=(0,s.useState)("Tous"),c="Tous"===e?r:r.filter(t=>t.category===e),[u,...d]=c;return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("div",{className:"flex flex-wrap items-center justify-center gap-2 mb-12",children:o.map(s=>(0,t.jsx)("button",{onClick:()=>l(s),className:`px-4 py-1.5 rounded-full text-sm font-medium transition-colors ${s===e?"bg-slate-900 text-white":"bg-slate-100 text-slate-600 hover:bg-slate-200"}`,children:s},s))}),u&&(0,t.jsx)("div",{className:"mb-12",children:(0,t.jsx)(a.default,{href:`/blog/${u.slug}`,className:"group block",children:(0,t.jsxs)("div",{className:"bg-slate-900 rounded-3xl p-8 md:p-12 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center hover:bg-slate-800 transition-colors",children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 mb-5",children:[(0,t.jsx)("span",{className:"bg-orange-500/20 text-orange-400 text-xs font-semibold px-3 py-1 rounded-full",children:u.category}),(0,t.jsxs)("span",{className:"text-slate-500 text-xs flex items-center gap-1",children:[(0,t.jsx)(i.Clock,{className:"w-3.5 h-3.5"}),u.readTime," de lecture"]})]}),(0,t.jsx)("h2",{className:"text-3xl font-bold text-white mb-4 leading-snug group-hover:text-orange-400 transition-colors",children:u.title}),(0,t.jsx)("p",{className:"text-slate-400 leading-relaxed mb-6",children:u.excerpt}),(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("div",{className:"w-9 h-9 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0",children:u.author.initials}),(0,t.jsxs)("div",{children:[(0,t.jsx)("div",{className:"text-sm font-semibold text-white",children:u.author.name}),(0,t.jsx)("div",{className:"text-xs text-slate-500",children:u.date})]})]})]}),(0,t.jsx)("div",{className:"flex justify-end",children:(0,t.jsxs)("div",{className:"inline-flex items-center gap-2 bg-orange-500 text-white font-semibold px-6 py-3 rounded-xl group-hover:bg-orange-600 transition-colors",children:["Lire l'article",(0,t.jsx)(n.ArrowRight,{className:"w-4 h-4"})]})})]})})}),d.length>0&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("h2",{className:"text-lg font-semibold text-slate-900 mb-6",children:"Tous"===e?"Tous les articles":`Articles — ${e}`}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6",children:d.map(e=>(0,t.jsx)(a.default,{href:`/blog/${e.slug}`,className:"group",children:(0,t.jsxs)("div",{className:"border border-slate-200 rounded-2xl p-6 hover:border-orange-200 hover:shadow-md transition-all h-full flex flex-col",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,t.jsx)("span",{className:"bg-slate-100 text-slate-600 text-xs font-semibold px-2.5 py-1 rounded-full",children:e.category}),(0,t.jsxs)("span",{className:"text-slate-400 text-xs flex items-center gap-1",children:[(0,t.jsx)(i.Clock,{className:"w-3 h-3"}),e.readTime]})]}),(0,t.jsx)("h3",{className:"font-bold text-slate-900 mb-3 leading-snug group-hover:text-orange-500 transition-colors flex-1",children:e.title}),(0,t.jsx)("p",{className:"text-sm text-slate-500 leading-relaxed mb-5 line-clamp-3",children:e.excerpt}),(0,t.jsxs)("div",{className:"flex items-center justify-between",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[(0,t.jsx)("div",{className:"w-7 h-7 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center text-white text-xs font-bold",children:e.author.initials}),(0,t.jsxs)("div",{children:[(0,t.jsx)("div",{className:"text-xs font-medium text-slate-700",children:e.author.name}),(0,t.jsx)("div",{className:"text-xs text-slate-400",children:e.date})]})]}),(0,t.jsx)(n.ArrowRight,{className:"w-4 h-4 text-slate-400 group-hover:text-orange-500 group-hover:translate-x-1 transition-all"})]})]})},e.slug))})]}),0===c.length&&(0,t.jsx)("div",{className:"text-center py-16 text-slate-400",children:"Aucun article dans cette catégorie pour le moment."})]})}],82388)},44969,e=>{"use strict";var t=e.i(43476);e.s(["default",0,function(){return(0,t.jsxs)("form",{onSubmit:e=>e.preventDefault(),className:"flex gap-3",children:[(0,t.jsx)("input",{type:"email",placeholder:"votre@garage.fr",className:"flex-1 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-slate-900"}),(0,t.jsx)("button",{type:"submit",className:"bg-slate-900 hover:bg-slate-800 text-white font-semibold px-5 py-3 rounded-xl text-sm transition-colors whitespace-nowrap",children:"S'abonner"})]})}])}]);